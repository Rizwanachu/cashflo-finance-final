          ...
          <Card>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-sm font-semibold mt-1 text-slate-900 dark:text-slate-50">
                  Cash position
                </div>
              </div>
            </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <ul className="divide-y divide-slate-200 dark:divide-slate-800 text-sm">
            {recentTransactions.map((t) => (
              <li key={t.id} className="py-2.5 flex items-center gap-3">
                <div className="h-9 w-9 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xs">
                  {t.type === "income" ? "⬇" : "⬆"}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex justify-between items-center mt-0.5 text-[11px] text-slate-500 dark:text-slate-400 gap-2">
        ...
        <Card>
          <h3 className="text-sm font-semibold tracking-tight mb-3 text-slate-900 dark:text-slate-50">
