    ...
    <div className={`rounded-lg border ${borderColor} p-6 ${bgColor}`}>
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 rounded-lg bg-[var(--brand-primary)] px-4 py-2 font-medium text-white hover:bg-[var(--brand-hover)] disabled:opacity-50"
            >
        ...
        <div>
          ...
          {importResult.importedCount > 0 && (
            <div className="mb-4 rounded-lg bg-green-50 p-3 dark:bg-green-900/30">
              <div className="flex gap-2 text-sm text-green-800 dark:text-green-300">
      ...
      {step === "complete" && (
        <div className="text-center">
          ...
          <button
            onClick={resetImport}
            className="rounded-lg bg-[var(--brand-primary)] px-6 py-2 font-medium text-white hover:bg-[var(--brand-hover)]"
          >
            Import More
          </button>
        </div>
