    ...
    <div className="w-full h-full" style={{ paddingLeft: "8px", paddingRight: "8px" }}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          <CartesianGrid
            strokeDasharray="3 3"
            stroke={resolvedTheme === "dark" ? "#1E293B" : "#E2E8F0"}
            vertical={false}
          />
          <XAxis
            dataKey="month"
            stroke={resolvedTheme === "dark" ? "#CBD5E1" : "#334155"}
            tick={{ fill: resolvedTheme === "dark" ? "#CBD5E1" : "#334155", fontSize: 11 }}
            tickLine={false}
            tickMargin={8}
          />
          <YAxis
          ...
          <Tooltip
            contentStyle={{
              ...
              border: `1px solid ${
                resolvedTheme === "dark" ? "#334155" : "#CBD5E1"
              }`,
